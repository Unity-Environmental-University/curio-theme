...
export const createScaffoldBuilder = (scaffoldBuilder, scaffoldClient, $) => {
    ...
    scaffoldBuilder.fetchstatus = function (response) {
    ...
    */
    scaffoldBuilder.fetchjson = function (response) {
    ...
    scaffoldBuilder.displayRubric = function () {
    ...
    scaffoldBuilder.accordionList = function () {
        // Accordion
    ...
    scaffoldBuilder.canvasModuleUtils = function () {
        return {
            pageInfo: {},
            urlTypes: ['Module Item', 'Page', 'Assignment', 'Quiz', 'Discussion', 'ExternalTool', 'File'],
            parseUrl: function (url) {
