...
export const createScaffoldClientMobile = (scaffoldClient) => {
...
// pre-load some api calls here
    ...
    scaffoldClient.init = function (options) {
...
// place list items
    ...
    scaffoldClient.getHomeCardsAsync = getHomeCardsAsync;
...
//console.log(`Course Progress:: ${asd}`)
    ...
    scaffoldClient.getNavHTML = function (navItem) {
